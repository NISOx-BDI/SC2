...
matlabbatch{4}.spm.stats.results.conspec(1).extent = 220;
...
matlabbatch{4}.spm.stats.results.conspec(2).extent = 222;
...
matlabbatch{4}.spm.stats.results.export{1}.nidm.group.nsubj = 15;

...
singularity exec --cleanenv -B /well/nichols/users/bas627/BIDS_Data/RESULTS/SC2 /apps/singularity/fsl-afni-spm12-conda.sif /opt/afni-latest/afni_proc.py -subj_id sub07                                                  \

...
singularity exec --cleanenv -B /well/nichols/users/bas627/BIDS_Data/RESULTS/SC2 /apps/singularity/afni-r-python3-2020-03-26-v1.sif /opt/afni-latest/afni_proc.py -subj_id sub10                                                  \
        ...
        -regress_stim_times                                                    \
            ...
            /well/nichols/users/bas627/BIDS_Data/RESULTS/SC2/results/ds001/AFNI/ONSETS/../MOTION_REGRESSORS/sub-10_combined_trans_x.1d                  \
            /well/nichols/users/bas627/BIDS_Data/RESULTS/SC2/results/ds001/AFNI/ONSETS/../MOTION_REGRESSORS/sub-10_combined_trans_y.1d                  \
            /well/nichols/users/bas627/BIDS_Data/RESULTS/SC2/results/ds001/AFNI/ONSETS/../MOTION_REGRESSORS/sub-10_combined_trans_z.1d                    \
            /well/nichols/users/bas627/BIDS_Data/RESULTS/SC2/results/ds001/AFNI/ONSETS/../MOTION_REGRESSORS/sub-10_combined_rot_x.1d                    \
            /well/nichols/users/bas627/BIDS_Data/RESULTS/SC2/results/ds001/AFNI/ONSETS/../MOTION_REGRESSORS/sub-10_combined_rot_y.1d                    \
            /well/nichols/users/bas627/BIDS_Data/RESULTS/SC2/results/ds001/AFNI/ONSETS/../MOTION_REGRESSORS/sub-10_combined_rot_z.1d                    \
        -regress_stim_labels                                                   \
